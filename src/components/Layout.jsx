    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <nav className="fixed w-full z-50 nav-blur">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link to="/" className="logo">ET</Link>
          <div className="flex gap-8">
            {location.pathname === "/" ? (
              ...
              <Link to="/" className="nav-link hover:text-primary transition-colors">Home</Link>
            )}
            <Link to="/blog" className="nav-link hover:text-primary transition-colors">Blog</Link>
            <Link to="/resume" className="nav-link hover:text-primary transition-colors">Resume</Link>
          </div>
        </div>
      </nav>
      <motion.main
